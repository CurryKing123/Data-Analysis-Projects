...
def GetData():
    #create csv
    with open('tech_jobs_2025.csv', mode='w', newline = '', encoding = 'utf-8') as file:
        writer = csv.writer(file)
        writer.writerow(['Job Title', 'Median Annual Salary', 'Estimated Growth Over 10 Years', 'Skills Needed'])
        ...
        for job in job_titles:
            ...
            writer.writerow([job_title, job_median_amount, job_growth, skills])
